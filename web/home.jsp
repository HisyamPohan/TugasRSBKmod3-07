...
<body style="background-color:#B7FEFD">
<div class="container" >
    <div class="jumbotron row" style="background-color:#6ED3D2">
	<center><h1><b>Data Mahasiswa</b></h1>
            <p><b>Modul RSBK - Kelompok07</b></p>
	...
	<div class="col-md-9 daftar">
            <form action="./StudentServlet" method="POST">
                ...
                <tr>
                <td colspan="2">
                <input type="submit" class="btn btn-success btn-lg" name="action" value="Add" />
                <input type="submit" class="btn btn-warning btn-lg" name="action" value="Edit" />
                <input type="submit" class="btn btn-danger btn-lg" name="action" value="Delete" />
                <input type="submit" class="btn btn-info btn-lg" name="action" value="Search" />
                </td>
                </tr>
                </table>
            </form>
